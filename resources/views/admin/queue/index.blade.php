...
<div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div>
        <h1 class="text-2xl font-bold text-gray-100">Queued Conversations</h1>
...
<div class="bg-gray-900 border border-gray-800 rounded-lg shadow-sm overflow-hidden">
    <div class="divide-y divide-gray-800">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center gap-4 px-6 py-5 hover:bg-gray-800 transition relative">
            <div class="flex-1 min-w-0 flex items-center gap-4">
                ...
                <div>
                    <div class="flex items-center gap-2 mb-1">
                        ...
                        <span class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium bg-yellow-900/30 text-yellow-300 uppercase tracking-wider">Waiting</span>
                    </div>
            ...
            <div class="flex items-center gap-2 shrink-0">
                ...
                <form method="POST" action="{{ route('agent.queue.join', $chat->id) }}">
                    @csrf
                    <button type="submit" class="inline-flex items-center px-4 py-2 border border-blue-600 text-sm font-medium rounded-md text-blue-600 bg-gray-900 hover:bg-blue-900/30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors">
                        Join as Admin
                    </button>
                </form>
            </div>
        ...
        <div class="px-6 py-24 text-center">
            <div class="inline-flex items-center justify-center w-20 h-20 rounded-full bg-blue-900/30 mb-6">
                <svg class="h-10 w-10 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
            </div>
            <h3 class="text-xl font-semibold text-gray-100">Zero Wait Time</h3>
