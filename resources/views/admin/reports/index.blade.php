...
<div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div>
        <h1 class="text-2xl font-bold text-gray-100">System Insights</h1>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
    ...
    @if(is_array($value))
    <div class="bg-gray-900 border border-gray-800 rounded-lg shadow-sm overflow-hidden col-span-1 md:col-span-2 lg:col-span-1">
        <div class="px-6 py-4 border-b border-gray-800 bg-gray-800 flex items-center justify-between">
            <h4 class="text-sm font-semibold text-gray-100 uppercase tracking-wider flex items-center gap-2">
        ...
        <div class="p-6">
            <dl class="space-y-4">
                ...
                <div class="flex justify-between items-center pb-4 border-b border-gray-50 last:border-0 last:pb-0">
                    ...
                    <dd class="text-sm font-bold text-gray-100">{{ is_numeric($subVal) ? number_format($subVal, 2) : $subVal }}</dd>
                </div>
                @endforeach
            </dl>
        </div>
...
<div class="bg-gray-900 border border-gray-800 rounded-lg shadow-sm p-12 text-center">
    ...
    <h3 class="mt-2 text-sm font-semibold text-gray-100">No Data Available</h3>
