...
<body class="bg-slate-950 min-h-screen flex items-center justify-center p-4 antialiased overflow-hidden">
    ...
    <div class="fixed top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
        <div class="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-[#F0644B]/10 blur-[120px] rounded-full"></div>
    ...
    <div class="w-full max-w-[380px]">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center gap-6">
                ...
                <div class="flex flex-col items-start">
                    <span class="text-[14px] font-black text-[#F0644B] uppercase tracking-[0.3em] leading-none mb-1.5">Nexon</span>
        ...
        <div class="bg-slate-900/80 backdrop-blur-2xl border border-slate-800 rounded-[2rem] p-8 shadow-2xl relative overflow-hidden">
            <div class="absolute top-0 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-[#F0644B]/50 to-transparent"></div>
            ...
            <form method="POST" action="/login" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-500 group-focus-within:text-[#F0644B] transition-colors">
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus
                            class="w-full bg-slate-800/50 border border-slate-700/50 rounded-xl pl-11 pr-4 py-2 text-xs text-slate-200
                                      placeholder-slate-600 focus:ring-2 focus:ring-[#F0644B]/20 focus:border-[#F0644B] transition-all outline-none"
                ...
                <button type="submit"
                    class="w-full bg-[#F0644B] hover:bg-[#d9533a] text-white font-bold py-3 px-4 rounded-xl transition-all duration-300 shadow-lg brand-shadow active:scale-[0.98] uppercase tracking-widest text-[10px]">
                    Sign In
                </button>
            </form>
        </div>
